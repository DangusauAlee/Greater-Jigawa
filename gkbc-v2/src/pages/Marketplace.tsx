  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {activeTab === 'browse' && isVerified && (
        <button
          onClick={() => setShowCreateModal(true)}
          className="fixed bottom-4 right-4 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
